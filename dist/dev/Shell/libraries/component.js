...
const lightpageModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/pages/lightpage/lightpage-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/pages/lightpage/lightpage-emulator.json");       
    }

    /**
     * private method for page class initialization
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:lightpage-import-page', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:lightpage-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    }); 
...
const settingspageModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/pages/settingspage/settingspage-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/pages/settingspage/settingspage-emulator.json");       
    }

    /**
     * private method for page class initialization
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:settingspage-import-page', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:settingspage-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    }); 
...
const videopageModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/pages/videopage/videopage-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       //serviceModule.addEmulatorScenario("./app/project/components/pages/videopage/videopage-emulator.json");       
    }

    /**
     * private method for page class initialization
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:videopage-import-page', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:videopage-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    }); 
...
const audiocontrolsInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`audiocontrols-widget audiocontrolsInstanceModule("${id}", [${elementIds}])`);
    ...
    const cleanup = () => {
        // console.log(`audiocontrols-widget audiocontrolsInstanceModule cleanup("${id}")`);
    };
...
const audiocontrolsModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/audiocontrols/audiocontrols-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/audiocontrols/audiocontrols-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:audiocontrols-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:audiocontrols-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     */
    CrComLib.subscribeState('o', 'ch5-template:audiocontrols-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = audiocontrolsInstanceModule(value.id, value['elementIds']);
            }
            else {
...
const circulebuttonsInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`circulebuttons-widget circulebuttonsInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`circulebuttons-widget circulebuttonsInstanceModule cleanup("${id}")`);
    };
...
const circulebuttonsModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/circulebuttons/circulebuttons-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/circulebuttons/circulebuttons-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:circulebuttons-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:circulebuttons-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:circulebuttons-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = circulebuttonsInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const controlpadsInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`controlpads-widget controlpadsInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`controlpads-widget controlpadsInstanceModule cleanup("${id}")`);
    };
...
const controlpadsModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/controlpads/controlpads-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/controlpads/controlpads-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:controlpads-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:controlpads-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:controlpads-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = controlpadsInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const dpadcontrolInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`dpadcontrol-widget dpadcontrolInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`dpadcontrol-widget dpadcontrolInstanceModule cleanup("${id}")`);
    };
...
const dpadcontrolModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/dpadcontrol/dpadcontrol-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/dpadcontrol/dpadcontrol-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:dpadcontrol-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:dpadcontrol-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:dpadcontrol-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = dpadcontrolInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const keypadcontrolInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`keypadcontrol-widget keypadcontrolInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`keypadcontrol-widget keypadcontrolInstanceModule cleanup("${id}")`);
    };
...
const keypadcontrolModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/keypadcontrol/keypadcontrol-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/keypadcontrol/keypadcontrol-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:keypadcontrol-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:keypadcontrol-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:keypadcontrol-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = keypadcontrolInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const lightcontrolwidgetInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`lightcontrolwidget-widget lightcontrolwidgetInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`lightcontrolwidget-widget lightcontrolwidgetInstanceModule cleanup("${id}")`);
    };
...
const lightcontrolwidgetModule = (() => {
    'use strict';
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/lightcontrolwidget/lightcontrolwidget-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/lightcontrolwidget/lightcontrolwidget-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:lightcontrolwidget-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:lightcontrolwidget-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:lightcontrolwidget-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = lightcontrolwidgetInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const lightquicklanchwidgetInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`lightquicklanchwidget-widget lightquicklanchwidgetInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`lightquicklanchwidget-widget lightquicklanchwidgetInstanceModule cleanup("${id}")`);
    };
...
const lightquicklanchwidgetModule = (() => {
    'use strict';
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/lightquicklanchwidget/lightquicklanchwidget-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/lightquicklanchwidget/lightquicklanchwidget-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:lightquicklanchwidget-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:lightquicklanchwidget-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:lightquicklanchwidget-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = lightquicklanchwidgetInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const pagedisplayInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`pagedisplay-widget pagedisplayInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`pagedisplay-widget pagedisplayInstanceModule cleanup("${id}")`);
    };
...
const pagedisplayModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/pagedisplay/pagedisplay-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/pagedisplay/pagedisplay-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:pagedisplay-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:pagedisplay-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:pagedisplay-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = pagedisplayInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const projectheaderInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`projectheader-widget projectheaderInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`projectheader-widget projectheaderInstanceModule cleanup("${id}")`);
    };
...
const projectheaderModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/projectheader/projectheader-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/projectheader/projectheader-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:projectheader-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:projectheader-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:projectheader-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = projectheaderInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const sourcecommandscontrolsInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`sourcecommandscontrols-widget sourcecommandscontrolsInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`sourcecommandscontrols-widget sourcecommandscontrolsInstanceModule cleanup("${id}")`);
    };
...
const sourcecommandscontrolsModule = (() => {
    'use strict';
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/sourcecommandscontrols/sourcecommandscontrols-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/sourcecommandscontrols/sourcecommandscontrols-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:sourcecommandscontrols-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:sourcecommandscontrols-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:sourcecommandscontrols-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = sourcecommandscontrolsInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const sourcelistInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`sourcelist-widget sourcelistInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`sourcelist-widget sourcelistInstanceModule cleanup("${id}")`);
    };
...
const sourcelistModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/sourcelist/sourcelist-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/sourcelist/sourcelist-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:sourcelist-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:sourcelist-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:sourcelist-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = sourcelistInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
...
const tvcontrolsInstanceModule = (id, elementIds) => {
    'use strict';    

    // BEGIN::CHANGEAREA - your initialization code for each instance of widget goes here  
    // console.log(`tvcontrols-widget tvcontrolsInstanceModule("${id}", [${elementIds}])`);
    ...
    // Your code for when widget instance removed from DOM here
    const cleanup = () => {
        // console.log(`tvcontrols-widget tvcontrolsInstanceModule cleanup("${id}")`);
    };
...
const tvcontrolsModule = (() => {
     ...
     */
    function onInit() {
       serviceModule.addEmulatorScenarioNoControlSystem("./app/project/components/widgets/tvcontrols/tvcontrols-emulator.json");
       // Uncomment the below line and comment the above to load the emulator all the time.
       // serviceModule.addEmulatorScenario("./app/project/components/widgets/tvcontrols/tvcontrols-emulator.json");
    }

    /**
     * private method for widget class creation
     */
    let loadedSubId = CrComLib.subscribeState('o', 'ch5-import-htmlsnippet:tvcontrols-import-widget', (value) => {
        if (value['loaded']) {
            onInit();
            setTimeout(() => {
                CrComLib.unsubscribeState('o', 'ch5-import-htmlsnippet:tvcontrols-import-page', loadedSubId);
                loadedSubId = '';
            });
        }
    });
     ...
     * private method for widget instance addition and removal
     */
    CrComLib.subscribeState('o', 'ch5-template:tvcontrols-widget', (value) => {
        if (value['loaded'] !== undefined && value['id'] !== undefined) {
            if (value.loaded) {
                widgetInstances[value.id] = tvcontrolsInstanceModule(value.id, value['elementIds']);
            }
            else {
                const removedInstance = widgetInstances[value.id];
                if (removedInstance) {
